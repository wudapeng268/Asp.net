    ...
    <div class="center_frame">
      <div class="top">
        <form name="search" method="post" action="">
          ...
          <div class="login" runat="server" id="logining"> <a href="login.aspx" class="login_img">&nbsp;</a> <a href="register.aspx" class="register">&nbsp;</a> </div>
      ...
      <div class="center_frame"> 
        ...
        <div id="login_detail">
          <form action="" runat="Server">
            <h6>登录</h6>
              <asp:TextBox ID="username" runat="server" type="text"  placeholder="用户名" class="input_1" ></asp:TextBox>
            ...
            <a href="forgetPwd.aspx" class="forget">忘记密码?</a> <a href="register.aspx" class="not_yet">还没有注册?</a>
          </form>
        </div>
        <!--Project Top Start Here --> 
