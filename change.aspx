    ...
    <div class="center_frame">
      <div class="top">
        <form name="search" method="post" action="">
         ...
         <div class="login" runat="server" id="Div1"> <a href="login.aspx" class="login_img">&nbsp;</a> <a href="register.aspx" class="register">&nbsp;</a> </div>
      ...
      <div class="center_frame"> 
        ...
        <div id="resetpwd">
            ...
            <h6>重置密码</h6>
              ...
              <asp:TextBox ID="repeatPwd" runat="server" type="text"  class="input_3" placeholder="确认密码" TextMode="Password"></asp:TextBox>
              
            <asp:TextBox ID="Email" runat="server" type="text" placeholder="邮箱" class="input_4" ReadOnly="True"></asp:TextBox>
